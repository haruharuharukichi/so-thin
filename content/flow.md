...
<h3>全体デザイン</h3>
<p>トップページと同じように全体をコーディング。今後はWordPressでテーマごと編集</p>
Xserverにログインして[頑張る](./flow)  
パスワードは大体全部GitHubと同じ（自分で設定する場合は任意で良し）
WordPressを最新版に更新してブロックエディタで編集するのを忘れずに

**目的：コンバージョンを達成できる流れの作成**

1. トップページの際にダウンロードしたテンプレのWPバージョンに変更を反映
1. WPをサブディレクトリに入れて、テンプレートのWPフォルダをthemesにアップロード（フォルダ名からWPを削除するのを忘れずに）
...
<h3>全体確認</h3>
開発環境のURL（ex. saw-so-thin.com/test）を見せて確認
...
[All-in-One WP Migration](https://its-office.jp/blog/wordpress/2016/04/16/WP-Migration.html)使うと便利
